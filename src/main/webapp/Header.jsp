...
<html>
    ...
    <body style="margin: 0;">
        <ul>
            ...
            <li class="uname"><img src="My_Pic1.jpg" style="margin-right:5px; height:50px; width=50px;border-radius:50%"><%=session.getAttribute("uname") %>
            <%}else{%>
            ...
            <li style="float:left"><img class="headerimg" src="sstech.png"></li>
